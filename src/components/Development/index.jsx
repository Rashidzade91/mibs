  ...
  return (
    <>
      <div className={classes.title}>
        <h1 style={{ textIndent: "150px" }}>Onlayn Mağaza Yaradılması</h1>
      </div>
      <section className={classes.store}>
        <div className="container">
          ...
          <div className="row">
            <div>
              <h1>İT şirkətimizlə əməkdaşlığa daxil olan fəaliyyətlərimiz</h1>
            </div>
            ...
            <div className={`${classes.offers} ${classes.same_clas}`}>
              <div>
                <img src={game} alt="" />
              </div>
