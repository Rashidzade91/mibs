            ...
            <div className="col-12 col-xl-8">
              <div className={classes.store_container}>
                ...
                <p>
                  ...
                  Buna görə də vaxtı, dəyəri və nəticələri nəzərə alırıq. Biz
                  qısa müddət ərzində ən sərfəli qiymətlərlə onlayn mağaza hazır
                  edirik ki, siz gecikmədən sifarişlərə başlaya və qəbul edə
                  biləsiniz.
                </p>
                <p>
            ...
            <div className={classes.user_container}>
              <div className="col-12 col-xl-8">
                ...
                <p>
                  ...
                  mağazalarını yaratmağı təklif edirik. Ani reaksiyalar üçün
                  bütün modulları və funksiyaları konfiqurasiya edirik.
                </p>
              </div>
            </div>
            <div className={classes.card_container}>
              ...
              <div className={classes.offers}>
                <div className={classes.list1}>
                  ...
                  <p>
                    <AiFillCaretRight className={classes.icon} />
                    endirimlər, cari təkliflər və tədbirlər haqqında məlumat
                    almaq üçün saytda qeydiyyatdan keçmək üçün şəxsi hesabın
                    tətbiqi.
                  </p>
                  <p>
                    <AiFillCaretRight className={classes.icon} />
                ...
                <div>
                  <img src={phone} alt="Phone" className="w-100 h-100" />
                </div>
              </div>
              <div className={`${classes.offers} ${classes.same}`}>
                <div>
                  <img src={game} alt="Game" className="w-100 h-100" />
                </div>
